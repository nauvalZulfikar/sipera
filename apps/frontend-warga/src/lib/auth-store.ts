...
// Single shared store so EVERY useUser() consumer (App, LoginPage, NotifBell, …)
// re-renders on login/logout. The previous per-component useState meant the App
// shell never saw the LoginPage's setUser → stayed on the login screen until reload.
