...
**Port:** 4003  
**Description:** Master data: wilayah, KBLI, kategori-zona, bulk CSV import, audit log
...
- [ ] Shadow mode via gateway flag `ROUTE_MASTER=new`
- [ ] Cutover when shadow zero-mismatch 1 week

## Run

```bash
pnpm --filter @sipera/master run dev
curl http://localhost:4003/_health
```
