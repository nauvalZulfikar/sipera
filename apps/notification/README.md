...
**Port:** 4007  
**Description:** Multi-channel notif (SMS/Email/WS/InApp), provider abstraction, BullMQ queue, i18n templates
...
- [ ] Shadow mode via gateway flag `ROUTE_NOTIFICATION=new`
- [ ] Cutover when shadow zero-mismatch 1 week

## Run

```bash
pnpm --filter @sipera/notification run dev
curl http://localhost:4007/_health
```
